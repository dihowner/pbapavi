...
<body class="bg-gray-100">
    <div class="flex items-center justify-center min-h-screen">
        <div class="flex flex-col md:flex-row md:w-10/12 bg-white items-center overflow-hidden">
            ...
            <div class="p-8 w-full rounded-lg">
                ...
                <div class="mb-6">
                    <p class="text-gray-600">
                        ...
                        Thank you for registering for <em><strong><?php echo $courseData['name']; ?></strong></em>, 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 my-8 border-y border-gray-300 py-6">
