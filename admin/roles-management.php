<?php 
$pageTitle = "Roles Management - Pavi Admin";
include_once '../components/admin-head.php'; 
$role_instance = new Roles($db);
$rolePermissions = $role_instance->get_roles_permissions();
...
<body>
    <div class="antialiased bg-gray-50 dark:bg-gray-900">
        ...
        <main class="p-4 md:ml-64 min-h-screen pt-20 ">
            <div class="container mx-auto py-12">
                    ...
                    <div class="w-full mb-1">
                        ...
                        <div class="grid grid-cols-6">
                            <div
                                ...
                                <h2 class="card-header"><strong>Roles Management</strong></h2>
                            </div>
                            <div
                                class="col-span-6 md:col-span-2 flex items-center justify-center md:ml-auto space-x-2 sm:space-x-3">
                                <button type="button" data-modal-target="add-role-modal"
                                            ...
                                            ?>
                                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                    ...
                                                    <td class="flex items-center justify-center p-4 space-x-3 whitespace-nowrap">
                                                        ...
                                                        <button type="button" data-modal-target="edit-role-modal<?php echo $roleId;?>"
                                                            data-modal-toggle="edit-role-modal<?php echo $roleId;?>"
                                                        ...
                                                        <?php if ($roleId != 1) { ?>
                                                            <button type="button" data-modal-target="delete-user-modal"
                                                                data-modal-toggle="delete-user-modal" data-id="<?php echo $roleId; ?>" data-name="<?php echo $roleTitle; ?>"
                                                                class="deleteRole inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900">
                                                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <path fill-rule="evenodd"
                                                    ...
                                                    <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
                                                        id="edit-role-modal<?php echo $roleId;?>">
                                                                ...
                                                                <form action="<?php echo CONTROLLER_PATH;?>roles.php" method="POST">
                                                                    <div class="p-6 space-y-6">
                                                                        ...
                                                                        <div class="grid grid-cols-6 gap-6">
                                                                            <div class="col-span-12 sm:col-span-6">
                                                                                <label for="role_name"
                                                                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Role Title</label>
                                                                                <input type="text" name="role_name" id="role_name"
                                                                                    value="<?php echo (isset($_SESSION['formInput']['role_name'])) ? $_SESSION['formInput']['role_name'] : $roleTitle; ?>"
                                                                                    ...
                                                                                    placeholder="Global Admin" required>
                                                                            ...
                                                                            <?php if (count($rolePermissions) > 0) { 
                                                                                foreach ($rolePermissions as $permission) { 
                                                                                    $rolePermitId = $permission['id']; ?>
                                                                                    <label class="dark:text-white">
                                                                                        <input type="checkbox" name="role_permissions[]" 
                                                                                            value="<?php echo $rolePermitId ;?>"
                                                                                            <?php echo in_array($rolePermitId, explode(',', $permissionIds)) ? "checked='checked'" : ""; ?>
                                                                                        >
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            type="submit" name="edit_role">Edit Role</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
                ...
                <?php include_once COMPONENT_MODAL_DIR.'add-roles.php';?>
    ...
    <script>
        $(".deleteRole").on("click", function() {
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: `Are you sure you want to delete this role (${roleName}). Deleting this will affect all admin on this role.`,
                icon: 'question',
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "<?php echo CONTROLLER_PATH;?>roles.php?delete_role=" + roleId;
