<?php 
$pageTitle = "Student Management - Pavi Admin";
include_once '../components/admin-head.php'; 
$student_instance = new Students($db);
$students = $student_instance->get_students();
?>
                    ...
                    <div class="w-full mb-1">
                        ...
                        <div class="grid grid-cols-6">
                            <div
                                ...
                                <h2 class="card-header"><strong>Student Management</strong></h2>
                            </div>
                            <div
                                    ...
                                    <tbody
                                        ...
                                        if (count($students) > 0) {
                                            foreach ($students as $studentIndex => $student) {
                                                ...
                                                $courseEnrol = $student['course_enrol'];
                                                ...
                                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                    ...
                                                    <td class="max-w-sm p-4 overflow-hidden text-base text-center font-normal text-gray-500 truncate xl:max-w-xs dark:text-gray-400">
                                                        <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                                            ...
                                                            <span class="d-flex" style="color: #fb7d8b">
                                                                Active Course: <?php echo number_format($courseEnrol - $courseCompleted); ?>
                                                            </span><br>
                                                            <span class="d-flex" style="color: #fb7d8b">
                                                                Course Completed: <?php echo number_format($courseCompleted); ?>
                                                            </span>
                                                        </div>
                                                    </td>                                                   
