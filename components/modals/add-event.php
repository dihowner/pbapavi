            ...
            <form action="<?php echo CONTROLLER_PATH;?>events.php" method="POST" enctype="multipart/form-data">
                <div class="p-6 space-y-6">
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-12 sm:col-span-6">
                            <label for="event_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Event Title</label>
                            <input type="text" name="event_title" id="event_title"
                                value="<?php echo (isset($_SESSION['formInput']['event_title'])) ? $_SESSION['formInput']['event_title'] : ''; ?>"
                                ...
                                placeholder="Become a Professional Data Analyst" required>
                        </div>

                        <div class="col-span-12 sm:col-span-6">
                            <label for="datetime" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Event Date</label>
                            <input type="datetime-local" id="datetime" name="datetime"
                                value="<?php echo (isset($_SESSION['formInput']['datetime'])) ? $_SESSION['formInput']['datetime'] : ''; ?>"
                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required>
                        </div>
                        ...
                        <div class="col-span-6">
                            ...
                            <textarea id="event_description" name="event_description" rows="4" placeholder="Description about this event..."
                                ...
                                ><?php echo (isset($_SESSION['formInput']['event_description'])) ? $_SESSION['formInput']['event_description'] : ''; ?></textarea>
                        </div>

                        <div class="col-span-12 sm:col-span-6">
                            <label for="datetime" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Event Banner</label>
                ...
                <div class="flex justify-end items-center p-6 border-t border-gray-200 rounded-b dark:border-gray-700">
                    <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                        type="submit" name="create_event">Create Event</button>
                </div>
            </form>
